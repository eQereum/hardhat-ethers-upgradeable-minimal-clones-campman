...
module.exports = {
  solidity: {
    compilers: [{ version: '0.4.18' }, { version: '0.4.24' }, { version: '0.5.16' }, { version: '0.6.12' }, { version: '0.6.6' }, { version: '0.7.6' }, { version: '0.8.0' }, { version: '0.8.2' }, { version: '0.8.10' }, { version: '0.8.13' }].map((opt) => ({ ...opt, settings })),
  },
